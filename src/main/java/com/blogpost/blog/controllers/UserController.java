...
//			  System.out.println("ADDDDDDDDDDDDD"+session.getAttribute("username"));
		...
		private ResponseEntity<ApiResponse> updateUser( @RequestBody Loginmaster userDto)
		{
		...
		private ResponseEntity<Loginmaster> getUserById( @PathVariable("username") String id)
		{
		...
		private ResponseEntity<List<Loginmaster>> getAllUsers()
		{
